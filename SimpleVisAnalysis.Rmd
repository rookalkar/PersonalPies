...
fit11_pie_data <- spread_draws(fit11_pie, b)
...
####1-Cycle
```{r}
aaa_pie_data = list(n = length(aaa_study_pie$ID), correct_ans = aaa_study_pie$correct_ans/100, response = aaa_study_pie$flipped_ans/100, segments=1)
